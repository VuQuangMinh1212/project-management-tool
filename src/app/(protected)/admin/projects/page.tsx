...
import { CalendarIcon, Plus, Search, Filter, Edit, Trash2, Eye } from 'lucide-react'
    ...
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Quản lý tất cả dự án trong hệ thống</p>
        </div>
        ...
        <CardContent className="space-y-4">
          ...
          {showFilters && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 border rounded-lg bg-muted/50">
              ...
              <div>
                <label className="text-sm font-medium mb-2 block">ID Người quản lý</label>
                <Input
